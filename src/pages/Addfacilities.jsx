...
function AddFacilities() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await fetch('https://api.swasthyapro.com/api/database/add-facility', {
        method: 'POST',
        headers: {
    ...
    <div className=" sm:p-6 md:p-8  bg-gray-50">
      <div className="bg-white rounded-lg shadow-lg max-w-3xl mx-auto p-6">
        <form onSubmit={(e) => e.preventDefault()}>
          <div className="mb-6">
            <label htmlFor="facilityName" className="block text-gray-700 text-sm sm:text-base font-semibold mb-2">
              Facility Name
            </label>
            <input
              id="facilityName"
          ...
          <div className="mb-6">
            <label htmlFor="imageUrl" className="block text-gray-700 text-sm sm:text-base font-semibold mb-2">
              Image URL
            </label>
            <input
              id="imageUrl"
