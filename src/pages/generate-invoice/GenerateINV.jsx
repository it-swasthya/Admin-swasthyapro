    ...
    <div style={{ padding: "10px", fontFamily: "Arial, sans-serif" }}>
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <input
              type="text"
              value={invoiceDetails.vender_code}
              onChange={(e) =>
                handleInvoiceChange("vender_code", e.target.value)
              }
              style={{ ...inputStyle, fontWeight: "600" }}
            />
          </div>
          ...
          <FormControl fullWidth variant="outlined" size="small">
            <InputLabel id="payment-method-label">Reverse Charge</InputLabel>
            <Select
              labelId="payment-method-label"
              value={invoiceDetails.Reverse_Charge}
              onChange={(e) =>
                handleInvoiceChange("Reverse_Charge", e.target.value)
              }
      ...
      >
        ...
        <div style={{ padding: "10px" }}>
          <button
            onClick={() => {
              setShowEmployeeCols(!showEmployeeCols);
              setRows([
                {
                  id: 1,
                  employeeName: "",
      ...
      >
        ...
        {grandTotal > 0 && (
          ...
          >
            Amount in Words: {towards.convert(grandTotal.toFixed(2))} Only
          </div>
        )}
      </div>
