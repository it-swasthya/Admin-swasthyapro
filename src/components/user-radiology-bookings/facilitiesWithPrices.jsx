...
import RadiologyTests from "./radiologyFacilities";

const FacilityWithPrices = ({ facilityName, searchQuery }) => {
    ...
    const getTests = async () => {
      ...
      try {
        const response = await axios.get(
          `https://api.swasthyapro.com/api/labs/radiology/search?query=${searchQuery || facilityName}`
        );
...
export default FacilityWithPrices;
