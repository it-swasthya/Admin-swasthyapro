      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 w-full max-w-xl relative">
        ...
        <div className="grid grid-cols-2 gap-4 text-sm text-gray-700">
          ...
          <div>
            ...
            {userData.first_name || userData.firstName || "N/A"}
          </div>
          <div>
            <strong>Last Name:</strong>{" "}
            {userData.last_name || userData.lastName || "N/A"}
          </div>
          {userData.organisation_name && (
            <div>
              <strong>Organisation Name:</strong>{" "}
              {userData.organisation_name || "N/A"}
            </div>
          )}
          {userData.ministry && (
            <div>
          ...
          <div>
            <strong>DOB:</strong>{" "}
            {userData.date_of_birth || userData.dob || "N/A"}
          </div>
          <div>
