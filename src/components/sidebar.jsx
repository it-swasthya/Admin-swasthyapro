...
function Sidebar({ sidebarOpen, setSidebarOpen, activeMenu, setActiveMenu }) {
  ...
  return (
    <>
      <div
        className={`hidden md:flex bg-gradient-to-b from-gray-900 via-gray-800 to-gray-700 text-white transition-all duration-300 
      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-gray-800">
          ...
          <button
            ...
            className="bg-transparent p-1 rounded-md hover:bg-gray-700"
          >
